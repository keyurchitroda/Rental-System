<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="company.aspx.cs" Inherits="RentSystem.admin.company" %>

<asp:Content ID="Content1" ContentPlaceHolderID="headercontent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="bodycontent" runat="server">
    <div class="col-sm-12 women_main" >
        <asp:HiddenField ID="hidComid" runat="server" />
        ...
        <div class="col-sm-6 fa-border" style="box-shadow: 2px 2px 4px 3px rgba(37, 37, 37, 0.39); padding: 30px; margin-left: 250px; margin-bottom: 50px; background-color: whitesmoke; border-color: black; border-radius: 10px;">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please Select Category Name" InitialValue="-Select Category-" CssClass="text-danger" ControlToValidate="ddlCategory"></asp:RequiredFieldValidator>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Insert Company Name" CssClass="text-danger" ControlToValidate="txtComName"></asp:RequiredFieldValidator>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <asp:Repeater ID="rptCompanyInfo" runat="server" OnItemCommand="rptCompanyInfo_ItemCommand">

                    <HeaderTemplate>

                        <table class="table table-responsive table-bordered" style="margin-left: 160px; box-shadow: 2px 2px 4px 3px rgba(37, 37, 37, 0.39);">
                    ...
                    <ItemTemplate>
                        <tr style="background-color: white;">
                            ...
                            <td>
                                <asp:LinkButton ID="lnkupdate" runat="server" CommandArgument='<%#Eval("CompanyId") %>' CommandName="edit" ToolTip="Edit" CssClass="btn btn-primary " CausesValidation="false"><i class="fa fa-edit"></i></asp:LinkButton>
                                <asp:LinkButton ID="lnkstatus" runat="server" CommandArgument='<%#Eval("CompanyId") %>' CommandName="status" ToolTip="Status" CssClass="btn btn-success" CausesValidation="false"><i class="fa fa-anchor"></i></asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
