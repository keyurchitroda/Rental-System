...
namespace RentSystem.Member
{
    public partial class Index : System.Web.UI.Page
    {
        ...
        protected void btnsearchCar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Member_Search.aspx?&Company=" + CarCompany + "&Model=" + CarModel + "&CarSubModel=" + CarSubmodel + "&CType=car");
        }
        ...
        protected void btnsearchHouse_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Member_Search.aspx?&State=" + State + "&City=" + City + "&Area=" + Area + "&HouseType=" + HouseType + "&CType=house");
        }
        ...
        protected void btnsearchCamera_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Member_Search.aspx?&Company=" + CameraCompany + "&Model=" + CameraModel + "&SubModel=" + CameraSubmodel + "&CType=camera");
        }
    }
}