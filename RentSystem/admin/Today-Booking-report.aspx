<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="Today-Booking-report.aspx.cs" Inherits="RentSystem.admin.Today_Booking_report" %>
    ...
    <div class="col-sm-12">
         <div class="row">
            ...
            <div class="col-lg-12" style="text-shadow: 10px 5px 5px #888888;">
                <center><h1><b>ToDay Booking</b></h1></center>
                <hr />
            </div>
            <!--End Page Header -->
