<%@ Page Title="" Language="C#" MasterPageFile="~/admin/main.Master" AutoEventWireup="true" CodeBehind="TodayUser.aspx.cs" Inherits="RentSystem.admin.TodayUser" %>
        ...
        <div class="col-sm-12">
         <div class="row">
            ...
            <div class="col-lg-12" style="text-shadow: 10px 5px 5px #888888;">
                <center><h1><b>ToDay User</b></h1></center>
                <hr />
            </div>
            <!--End Page Header -->
